...
|Lecture 4|03/26|Topics: Machine Learning with Shallow Neural Networks II(<a href="http://www.charuaggarwal.net/Chap2slides.pdf">slides)</a>|Paper review:<ul><li><a href="https://github.com/bart7449/lecture2021a/blob/slides/Doc2Vec_review_yjy.pdf">[Le14a]</a>유주연<li>[Bojanowski17a]이준영|
|Lecture 5|04/02|Topics: Training Deep Neural Networks I(<a href="http://www.charuaggarwal.net/Chap3slides.pdf">slides</a>)|Paper review:<ul><li>[Grover16a]공병윤<li>[Ioffe15a]이건호 |
|Lecture 6|04/09|Topics: Training Deep Neural Networks II(<a href="http://www.charuaggarwal.net/Chap3slides.pdf">slides</a>)|Paper Review:<ul><li>[Hinton15a]김정민 |
