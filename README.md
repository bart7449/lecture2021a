...
|Lecture 7|04/16|Topics: Training Deep Neural Networks II(<a href="http://www.charuaggarwal.net/Chap3slides.pdf">slides</a>)<br>Topics: Teaching Deep Learners to Generalize (<a href="http://www.charuaggarwal.net/Chap4slides.pdf">slides</a>)|Paper Review: <ul><li><a href="https://github.com/bart7449/lecture2021a/blob/slides/Weight_Initializaiton_review_ydh.pdf">[Glorot10a],[He2015a]</a>(<a href="https://github.com/bart7449/lecture2021a/blob/slides/Weight%20Initialization%20Test.ipynb">code</a>)양동헌 |
|Lecture 8|04/23|Topics: Convolutional Neural Networks I(<a href="http://www.charuaggarwal.net/Chap8slides.pdf">slides</a>)| Paper review:<ul><li>[Ba2016a] |
